          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-6 flex flex-col items-center max-w-4xl">
              ...
              <p className="mx-auto max-w-[700px] text-lg md:text-xl text-muted-foreground">
                Discover the <del aria-hidden="true">best</del><span className="sr-only">best</span> fan translations of <strong>Asian</strong> web novels. Immerse yourself in captivating stories from
                across Asia.
              </p>
