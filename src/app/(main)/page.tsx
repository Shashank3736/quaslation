        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-4 flex flex-col items-center">
              <h1 className="flex text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                Welcome to <SVGText text='Quaslation' />
              </h1>
              <p className="mx-auto max-w-[700px] md:text-xl">
                Discover the best <del>fan</del> translations of <strong>Asian</strong> web novels. Immerse yourself in captivating stories from
                across Asia.
              </p>
            </div>
          </div>
